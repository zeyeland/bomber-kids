...
function itemBombUp(x,y){
    ...
    this.itemImage.src = "assets/passed_sprites/bombUp.png";
...
function itemPowerUp(x,y){
    ...
    this.y = y;
    this.itemImage = new Image();
    this.itemImage.src = "assets/passed_sprites/powerUp.png";
...
function itemHeartUp(x,y){
    ...
    this.y = y;
    this.itemImage = new Image();
    this.itemImage.src = "assets/passed_sprites/heartUp.png";
